...
# Método para obtener la información de un autor
    ...
    def scrape_about_page(url):
        ...
        about_content = soup.find('div', class_='about-content').text.strip()
        return about_content

    # En la función principal
    about_url = "http://quotes.toscrape.com/about"
    about_content = scrape_about_page(about_url)
    # Aquí podríamos guardar el contenido en la base de datos o en un archivo